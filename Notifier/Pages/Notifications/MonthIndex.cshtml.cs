...
{
    public class IndexMonthModel : PagesTransactions.DI_BasePageModel
    {
        ...
        public async Task<IActionResult> OnPostExportAsync()
        {
            ...
            var NotifsList = from n in Context.Notification
                             where n.OwnerID == UserID && n.CreationDate > lastMonth
            ...
            string excelName = $"MonthNotificationReport-{DateTime.Now.ToString("yyyyMMddHHmmss")}.xlsx";
